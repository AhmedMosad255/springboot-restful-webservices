...
import net.javaguide.springboot.exception.EmailAlreadyExistsException;
import net.javaguide.springboot.exception.RecourseNotFoundException;
import net.javaguide.springboot.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDto getUserById(Long userId) {
        User user = userRepository.findById(userId).orElseThrow(
                () -> new RecourseNotFoundException("User", "id", userId)
        );
    ...
    public UserDto updateUser(UserDto user) {
        User existingUser = userRepository.findById(user.getId()).orElseThrow(
                () -> new RecourseNotFoundException("User", "id", user.getId())
        );
